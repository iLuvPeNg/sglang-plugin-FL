...
def _moe_filter_expert(obj) -> bool:
    """Return True if this MoE configuration is not supported yet."""
...
def fused_moe_iluvatar(
    ...
    """Fused MoE — partial Iluvatar support."""
    if _moe_filter_expert(obj):
        raise NotImplementedError(
            "fused_moe_iluvatar not available for this configuration; "
            "falling back to flaggems/reference"
        )
